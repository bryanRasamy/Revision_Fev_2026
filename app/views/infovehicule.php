...
<body class="bg-light">
    ...
    <main class="py-5">
        <section class="container">
            <h1 class="text-center fw-bold text-dark mb-5 display-4">Liste des Vehicules dans la societe</h1>

             <div class="mb-4">
                <div class="alert alert-info border-0 shadow-sm mb-3" role="alert">
                    <h5 class="alert-heading mb-0">
                        <i class="fas fa-filter me-2"></i>Vehicules
                    </h5>
                </div>
            </div>
            ...
            <table class="table table-striped table-bordered table-sm align-middle shadow-sm">
                ...
                <tbody>
                    ...
                    ?>    
                        <tr> 
                            <td><?php echo $vehicule['nom_vehicule']; ?></td>
