                            ...
                            <form action="<?= BASE_URL ?>/gestion/livraison/inserer" method="post">
                                <?php if(!empty($resultats)){
                                    foreach($resultats as $resultat){
                                        ...
                                        if(isset($resultat['zone'])){
                                            $allzone=$resultat['zone'];
                                        }
                                    }
                                ?>
                                            ...
                                            <div class="col-4">
                                                <select class="form-select" aria-label="Default select example" name="voiture"> 
                                                    ...
                                                    <?php foreach($allvehicule as $vehicule) {?>
                                                        <option value="<?= $vehicule['id_vehicule'] ?>"><?= $vehicule['nom_vehicule'] ?>-<?= $vehicule['immatriculation'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row g-2 align-items-center mt-3">
                                            ...
                                            <div class="col-4">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" name="zonelivraison"> 
